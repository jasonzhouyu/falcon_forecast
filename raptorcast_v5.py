...
# ============================================================
# 合并所有猛禽到 SPECIES_CONFIG
# ============================================================
SPECIES_CONFIG = {}
SPECIES_CONFIG.update(RAPTORS_PANDIONIDAE)
SPECIES_CONFIG.update(RAPTORS_KITE_EAGLE)
SPECIES_CONFIG.update(RAPTORS_VULTURE)
SPECIES_CONFIG.update(RAPTORS_HARRIER)
SPECIES_CONFIG.update(RAPTORS_HAWK)
SPECIES_CONFIG.update(RAPTORS_BUTEO)
SPECIES_CONFIG.update(RAPTORS_EAGLE)
SPECIES_CONFIG.update(RAPTORS_FALCON)
SPECIES_CONFIG.update(RAPTORS_OWL)
